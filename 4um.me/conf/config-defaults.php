...
$Configuration['ForumDatabase']['Engine']                           = 'MySQL';
$Configuration['ForumDatabase']['Host']                             = 'dbhost';
$Configuration['ForumDatabase']['Name']                             = 'dbname';
$Configuration['ForumDatabase']['User']                             = 'dbuser';
$Configuration['ForumDatabase']['Password']                         = '';
$Configuration['ForumDatabase']['ConnectionOptions']                = array(
                                                                  12 => FALSE, //PDO::ATTR_PERSISTENT => FALSE,
                                                                  1000 => TRUE, // PDO::MYSQL_ATTR_USE_BUFFERED_QUERY is missing in some php installations
                                                                  1002 => "set names 'utf8'" // PDO::MYSQL_ATTR_INIT_COMMAND is missing in PHP 5.3, so I use the actual value "1002" instead
                                                               );
$Configuration['ForumDatabase']['CharacterEncoding']                = 'utf8';
$Configuration['ForumDatabase']['DatabasePrefix']                    = 'GDN_';
$Configuration['ForumDatabase']['ExtendedProperties']['Collate']     = 'utf8_unicode_ci';
...
$Configuration['Forum']['Title'] = '4um.me';
