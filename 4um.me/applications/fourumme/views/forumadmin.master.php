...
<header>
  ...
  <div class="header">
	...
	<?php 
		...
		if($Session->UserID > 0){
			echo Anchor('Logout', SignOutUrl(), array('class'=>'headerLink'));
			echo Anchor('4um.me', 'fourumme/welcome', array('class'=>'headerLink'));
			echo Anchor('Forum Home', 'fourumme/forum?Forum='.$this->Path, array('class'=>'headerLink'));
		}else{ ?>
			<ul>
